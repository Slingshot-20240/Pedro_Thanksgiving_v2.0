package org.firstinspires.ftc.teamcode.misc.selfTunePID;
...
public class SelfTunePID extends LinearOpMode {
    ...
    private final double f = 0;  // how much  oscillation be allowed
    ...
    public void runOpMode() {
        ...
        shooterMotor = hardwareMap.get(DcMotor.class, "slideMotor");
    ...
    private void controlLoop() {
        ...
        power += f;
        shooterMotor.setPower(Range.clip(power, -1, 1));
