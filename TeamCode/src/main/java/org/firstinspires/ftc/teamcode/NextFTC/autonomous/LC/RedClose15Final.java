...
//                .setTangentHeadingInterpolation().setReversed()
        ...
        scoreSet2 = follower().pathBuilder()
                //Score Set 2
                .addPath(
                        new BezierLine(new Pose(126, 79), scorePose)
                )
...
//                .setTangentHeadingInterpolation()
        ...
        scoreSet3 = follower().pathBuilder()
                //Score set 3
                .addPath(
                        new BezierLine(new Pose(126.5, 70), scorePose)
                )
...
//                .setLinearHeadingInterpolation(Math.toRadians(43), Math.toRadians(0))
        ...
        scoreSet4 = follower()
                ...
                .setLinearHeadingInterpolation(follower().getHeadingError(), Math.toRadians(45))
//                .setHeadingInterpolation(
//                        HeadingInterpolator.piecewise(
//
//                                new HeadingInterpolator.PiecewiseNode(
    ...
    private Command autonomous() {
        return new SequentialGroup(
                ...
                new ParallelGroup(
                        ...
                        asc.i.transferSequence(scoreSet2,1.5)
                ),
                ...
                new ParallelGroup(
                        ...
                        asc.i.transferSequence(scoreSet3,1.5)
                ),
                ...
                new ParallelGroup(
                        ...
                        asc.i.transferSequence(scoreSet4,1.5)
                ),
