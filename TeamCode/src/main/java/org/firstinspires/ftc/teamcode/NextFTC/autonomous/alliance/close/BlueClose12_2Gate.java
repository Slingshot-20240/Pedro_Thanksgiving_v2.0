...
public class BlueClose12_2Gate extends NextFTCOpMode {
    public BlueClose12_2Gate() {
        addComponents(
...
//                .setTangentHeadingInterpolation()
                ...
                .addPath(
                        new BezierCurve(
                                new Pose(131, 54.000).mirror(),
                                new Pose(118, 54.000).mirror(),
                                new Pose(110.000, 69.000).mirror(),
                                new Pose(127.4, 70).mirror()
                        )
                )
                .setLinearHeadingInterpolation(Math.toRadians(180-0), Math.toRadians(180-90))
        ...
        scoreSet3 = follower().pathBuilder()
                //Score set 3
                .addPath(
                        new BezierLine(new Pose(127.4, 70).mirror(), scorePose)
                )
...
//                .setLinearHeadingInterpolation(Math.toRadians(180-43), Math.toRadians(180-0))
        ...
        park = follower()
                ...
                .addPath(
                        new BezierLine(scorePose, new Pose(110,70).mirror())
                )
                .setLinearHeadingInterpolation(Math.toRadians(180-43), Math.toRadians(180-90))
